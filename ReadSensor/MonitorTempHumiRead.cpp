...
CMonitorTempHumiRead::CMonitorTempHumiRead(CDevice* pDevice) : ThreadBase(pDevice)
{

}

CMonitorTempHumiRead::~CMonitorTempHumiRead()
{
}



void CMonitorTempHumiRead::Run()
{
	if (-1 == wiringPiSetup())
	{
...
//上电1s内不操作，维持电平稳定
*/
void CMonitorTempHumiRead::GPIO_init(int gpio_pin)
{
...
//起始信号
	...
	3.主机末状态是高电平，等待
*/
void CMonitorTempHumiRead::DHT11_start(int gpio_pin)
{
...
*/
uint8 CMonitorTempHumiRead::DHT11_read(int gpio_pin)
{
	uint8 crc, i;
...
void CMonitorTempHumiRead::BeginRecvTempHumi()
{
    GPIO_init(2);
